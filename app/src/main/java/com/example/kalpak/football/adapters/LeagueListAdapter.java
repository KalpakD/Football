...
public class LeagueListAdapter extends RecyclerView.Adapter<LeagueListAdapter.BindingHolder> {
    ...
    @NonNull
    @Override
    public LeagueListAdapter.BindingHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LeagueListAdapter.BindingHolder holder, final int position) {
        ...
        binding.leaguelist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("League_detail", model);
    ...
    class BindingHolder extends RecyclerView.ViewHolder {
        ...
        BindingHolder(LeagueRowBinding binding) {
