...
public class PlayerListAdapter extends RecyclerView.Adapter<PlayerListAdapter.BindingHolder> {
    ...
    @NonNull
    @Override
    public PlayerListAdapter.BindingHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PlayerListAdapter.BindingHolder holder, final int position) {
        ...
        binding.playerlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("player_detail", model);
    ...
    class BindingHolder extends RecyclerView.ViewHolder {
        ...
        BindingHolder(PlayerRowBinding binding) {
