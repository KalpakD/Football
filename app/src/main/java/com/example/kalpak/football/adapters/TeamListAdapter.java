...
@Override
public TeamListAdapter.BindingHolder onCreateViewHolder(ViewGroup parent, int viewType) {
...
@Override
public void onBindViewHolder(TeamListAdapter.BindingHolder holder, final int position) {
...
public void onClick(View v) {
                ...
                intent.putExtra("team_detail", (Parcelable) model);
...
public class BindingHolder extends RecyclerView.ViewHolder {
    ...
    public BindingHolder( TeamRowBinding binding) {
